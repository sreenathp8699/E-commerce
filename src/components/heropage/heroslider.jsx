...
const Heroslider = () => {
  ...
  return (
    ...
    <div className="flex transition-transform duration-300" style={{transform:`translateX(-${currentindex * (100/productData.length)}%)` , width: `${productData.length * 100}%`}}>
            ...
            <div key={product.id}>
              <div className="grid grid-cols-1 sm:grid-cols-2">
                <div className="flex flex-col justify-center gap-4 pt-12 sm:pt-0 text-center sm:text-left order-2 relative left-34 z-10">
                  <h1 className="text-5xl lg:text-7xl sm:text-6xl font-bold">{product.title}</h1>
